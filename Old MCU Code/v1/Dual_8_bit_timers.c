...
void Update_Pulse_a(uint16_t pw)
{
    pulsewidth_servo_a = (16 * pw) / 2200 ;
}

void Update_Pulse_b(uint16_t pw)
{
    pulsewidth_servo_b = (16 * pw) / 2200 ;
}
...
int main(void)
{
    ...
    uint16_t pw = 16; //16 bin value _ 2200 * 0.007
    uint16_t K = 1;
